...
//                                             39  // A1
//                                             40  // A2
static const uint8_t TEMP_TEST_TRIGGER_PIN =   41;  // A3
static const uint8_t EXTERNAL_TEST_A_PIN  =    42;  // A4
static const uint8_t EXTERNAL_TEST_B_PIN  =    43;  // A5
static const uint8_t CAP_TEST_TRIGGER_PIN  =   44;  // A7
static const uint8_t LED_SCANNER_PIN  =        45;  // A6
  

int16_t getTemperaturePixel(uint8_t pixelNum);
int16_t getAmbient();
void turnMinimum(bool direction);
...
static const uint8_t EAST_HEADING =       256 * 2/8;	  // heading divides the unit circle into 256 parts 0-255
static const uint8_t NORTHEAST_HEADING =  256 * 1/8;
static const uint8_t NORTH_HEADING =	        0  ; 
...
static const uint8_t TPA81_ADDR = 0xD0 >> 1;                          // Address of TPA81 thermopile array
    ...
    static const uint8_t TPA81_AMBIENT_REG = 1;  //Ambient Temperature 
    static const uint8_t TPA81_TEMP1_REG = 2;	 //Pixel 1 Temperature
    static const uint8_t TPA81_TEMP2_REG = 3;	 //Pixel 2 Temperature
    static const uint8_t TPA81_TEMP3_REG = 4;	 //Pixel 3 Temperature
    static const uint8_t TPA81_TEMP4_REG = 5;	 //Pixel 4 Temperature 
    static const uint8_t TPA81_TEMP5_REG = 6;	 //Pixel 5 Temperature 
    static const uint8_t TPA81_TEMP6_REG = 7;	 //Pixel 6 Temperature 
    static const uint8_t TPA81_TEMP7_REG = 8;	 //Pixel 7 Temperature 
    static const uint8_t TPA81_TEMP8_REG = 9;	 //Pixel 8 Temperature
