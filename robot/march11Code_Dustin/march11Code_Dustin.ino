...
Task_t nextTask;
Task_t previousTask;
Direction_t previousTaskDirection;
...
OperationalMode_t operationalMode =  STATIC_VOLTAGE_TEST; // testing mode
...
void setup()			  // run once, when the sketch starts 
{
  ...
  boolean startButtonBeenPushed = false;
  attachInterrupt(3, startButtonFallingHandler, FALLING); // left whisker made contact
  attachInterrupt(3, startButtonRisingHandler, RISING); // left whisker released contact
