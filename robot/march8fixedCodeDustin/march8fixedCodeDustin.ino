...
enum OperationalMode_t{LCD_TEST, STATIC_VOLTAGE_TEST , STATIC_CAPACITANCE_TEST , STATIC_TEMPERATURE_TEST , STATIC_SIGNAL_TEST , RADIO_CONTROL_DRIVE_TEST, AUTONOMOUS_DRIVE_TEST, QUANTIFY_SPEEDS_TEST,
...
//OperationalMode_t operationalMode = START;                  // competition mode.
 ...
 // create elapsedMillis outside loop(), to
    ...
    elapsedMillis sinceDisplayStatus1;//  current task, current task measurement, current task decision, color, side of course
    elapsedMillis sinceDisplayStatus2;// battery volts, compass direction, ambient temp, temp Array
    elapsedMillis sinceDisplayWheelCurrents;
    elapsedMillis sinceDisplayWheelSpeeds;
    elapsedMillis sinceDisplayWheelEncoders;
    elapsedMillis sinceDisplaySonars;
